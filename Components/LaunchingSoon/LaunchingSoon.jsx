...
function LaunchingSoon({ isMobile = false }) {
  ...
  return (
    <div className="border-secondary hidden border-2 lg:block">
      <div
        className={`border-secondary font-khand flex justify-center border-b-2 py-4 text-2xl font-semibold ${
          resolvedTheme === "dark"
