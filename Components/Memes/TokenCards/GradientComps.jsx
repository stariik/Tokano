const StakeIcon = () => (
  <div className="relative z-10">
    <div className="flex w-10 items-center justify-center rounded-full bg-white lg:w-10 xl:w-12 2xl:w-10">
      <svg
        className="w-16"
        viewBox="0 0 57 57"
        fill="none"
...
export const StakeGrad = ({ poolData }) => {
  ...
  return (
    <div className="relative flex">
      ...
      <div className="flex flex-col justify-center">
        <div
          className="font-khand -ml-4 rounded-r-2xl py-0.5 pr-1 pl-4 text-xs font-bold lg:pr-2 lg:pl-5"
          style={{
            background: "linear-gradient(90deg, #00459b 0%, #5eead4 100%)",
          }}
        >
          {calculateTimeLeft()}
        </div>
