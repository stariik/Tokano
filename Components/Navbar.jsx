        ...
        >
          ...
          >
            <circle
              ...
              cy="13.3891"
              r="13.3891"
              transform="rotate(90 13.3882 13.3891)"
              fill="#292B8C"
            />
          </mask>
          <g mask="url(#mask0_446_22076)">
            <circle
              cx="13.2632"
              cy="13.3891"
              r="13.3891"
              transform="rotate(90 13.2632 13.3891)"
              fill={isActive ? "white" : "#887FD4"}
            />
          </g>
          <path
            d="M12.3885 7.25145C12.4689 7.25174 12.5347 7.38153 12.535 7.54149L12.535 9.48778L14.2898 9.48777L14.2898 7.5327C14.29 7.3775 14.354 7.25162 14.4324 7.25145L17.1346 7.25144C17.213 7.25156 17.277 7.37745 17.2771 7.53269L17.2771 9.48777L19.4041 9.48776C19.4394 9.48783 19.4742 9.50087 19.5008 9.5239L22.2137 11.8891C22.3139 11.9774 22.2513 12.1428 22.117 12.143L4.65411 12.1431C4.51959 12.1429 4.45672 11.9774 4.55743 11.8892L7.27031 9.52392C7.29693 9.5008 7.3316 9.48783 7.36699 9.48779L9.46465 9.48778L9.46465 7.54149C9.46489 7.38147 9.53062 7.25163 9.61113 7.25145L12.3885 7.25145Z"
            fill="#292B8C"
          />
          <path
            d="M19.4052 13.8076C19.4406 13.8076 19.4752 13.8205 19.5019 13.8437L22.2148 16.2089C22.3159 16.2972 22.2528 16.4629 22.1181 16.4629L17.286 16.4629L17.2861 17.8291C17.2858 17.9473 17.1926 18.0429 17.0771 18.0429L9.69621 18.043C9.5807 18.0429 9.48743 17.9473 9.48722 17.8291L9.48722 16.4629L4.65421 16.4629C4.51971 16.4626 4.45658 16.2971 4.55753 16.209L7.27139 13.8437C7.29805 13.8206 7.33261 13.8076 7.36807 13.8076L19.4052 13.8076Z"
            fill="#292B8C"
          />
        </svg>
      ),
        ...
        <div className="flex items-center justify-around text-sm">
          {navigationItems.map((item) => (
            ...
            >
              ...
              <span className="font-khand text-xs">{item.name}</span>
            </Link>
          ))}
        </div>
      </div>
