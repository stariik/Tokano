...
function Navbar() {
  ...
  return (
    <>
      ...
      <div className="dark:bg-dark dark:text-light fixed top-0 z-50 w-full border-b border-gray-200 bg-white py-4 text-black lg:hidden dark:border-transparent">
      ...
      <div
        className="text-light fixed bottom-0 z-50 w-full py-3 lg:hidden"
        style={{
          background:
            resolvedTheme === "dark"
