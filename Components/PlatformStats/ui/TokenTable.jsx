  ...
  return (
    <div>
      <div className="font-khand border-x border-secondary">
        <div className="flex items-center justify-start p-2 border-secondary border-b md:text-lg font-semibold bg-[#f5f3fb] dark:bg-[#2A1C78]">
          <h1>Largets M-caps</h1>
        </div>
        {tableData.map((row) => (
          <div
            key={row.id}
            className="col-span-3 bg-[#eeeded] dark:bg-[#120e21]"
            // style={{
            //   background:
