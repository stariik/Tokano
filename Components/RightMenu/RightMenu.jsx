...
function RightMenu() {
  ...
  return (
    <div className="font-khand font-normal">
      ...
      {show && (
        <div
          className="menu-overlay-active xl:hidden fixed inset-0 bg-black/60 z-50 backdrop-blur-sm"
      ...
      <div
        className={`
          ...
          xl:static xl:z-0 xl:w-auto xl:shadow-none xl:translate-x-0 xl:h-auto xl:pb-0 xl:border-2 xl:top-2
        `}
      >
        <div
