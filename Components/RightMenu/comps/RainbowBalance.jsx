    ...
    <div className="rainbow-balance-wrapper relative flex h-7 w-full ">
        ...
        {percents.map((item) => {
          ...
          return (
            <span
              ...
              className={`cursor-pointer text-xs font-bold transition-all select-none xl:text-sm ${
      ...
      <div className="absolute -top-1.5 -right-1.5 z-10 flex items-center rounded-l-full pl-1 pr-1.5 py-1.5 dark:bg-[#1a0033]">
        {resolvedTheme === "dark" ? (
          // 🌙 DARK MODE SVG
          <svg
            className="h-[26px] w-[26px] lg:h-[28px] lg:w-[28px]"
            width="33"
            height="33"
            viewBox="0 0 33 33"
            fill="none"
      ...
      {/* <div className="relative z-10 -ml-7 flex items-center rounded-full bg-[#f5f3fb] p-1 md:-ml-5 lg:-ml-5 xl:-ml-2 dark:bg-[#1a0033]"> */}
    </div>
  );
}
