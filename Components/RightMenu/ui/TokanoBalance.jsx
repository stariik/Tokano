...
export default function TokanoBalance() {
  return (
    <div className="border-2 border-[#7B3FE4]  bg-[#1a0033]">
      ...
      <div className="flex items-center ml-4 mt-2">
        <span className="text-white/80 text-sm pr-2">Available:</span>
        <span className="text-white font-bold text-lg">13,000,239.12</span>
      </div>
      {/* Progress Bar & Stake Row */}
      <div className="py-2 flex bg-[#1a0033] justify-between items-center pr-4">
        {/* Progress bar */}
