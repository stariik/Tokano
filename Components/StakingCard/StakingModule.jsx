  ...
  return (
    <div className="w-full rounded-4xl border-2 border-secondary overflow-hidden">
      <div className="grid grid-cols-2 bg-gradient-to-r from-[#574DDD] to-[#330E79]">
        {/* Left side */}
        <div
          className={`flex justify-between items-center p-4 text-4xl text-white ${khandSemibold.className} border-r-2 border-secondary`}
        >
          ...
          <div className="flex items-center justify-center w-full">
            <img src="/image.png" alt="" className="w-12 rounded-full m-4" />
            FIRED
          </div>
        </div>
        ...
        <div className="p-4">
          {stats.map((stat, index) => (
            <div
              key={index}
              className={`flex justify-between items-center text-lg text-white last:mb-0 ${khandMedium.className}`}
            >
      ...
      <div className="bg-gradient-to-r from-[#130C71] to-[#173991] text-white py-4">
        <div className="grid grid-cols-3">
          ...
          <div className="bg-gradient-to-t from-[#0A0C50] to-[#24068E] px-4 py-2 text-white flex flex-col items-center rounded-xl border-2 border-secondary relative">
            {/* Top Row */}
            <div className="flex justify-between items-center w-full">
              <div className="h-full flex items-center">
                <span className={`text-lg mt-1 ${khandMedium.className}`}>
                  You will <br /> Stake:
                </span>
              </div>
              <div className="flex flex-col">
                <span className={`text-2xl ${khandSemibold.className}`}>
                  1,234,222.00
                </span>
            ...
            {/* Bottom Text */}
            <div
              className={`absolute right-2 bottom-0 text-sm flex justify-end w-full ${khandMedium.className}`}
            >
        ...
        <div
          className={`mt-6 mx-28 text-center text-sm ${khandMedium.className}`}
        >
