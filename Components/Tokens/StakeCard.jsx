  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="font-khand absolute top-12 right-0 rounded-l-2xl bg-[#2B923E] pr-0.5 pl-2 text-xs font-normal text-white sm:pr-1 md:top-16 xl:text-sm dark:bg-[#2B923E]">
          {stakeTimestamp || "N/A"}
        </div>
        <div
