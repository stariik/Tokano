        ...
        <div className="mt-6 flex justify-between rounded-full border-2 border-[#949DFF] bg-[#e8e4f8] dark:bg-[#453DC8]">
          ...
          <div className="flex items-center text-xs text-[#190E79] md:text-base">
            <button
              ...
              className="relative flex cursor-pointer rounded-full bg-[#0E1379] px-2.5 transition-colors hover:bg-[#1a1f9e] disabled:cursor-not-allowed disabled:bg-gray-500 md:px-4 py-1"
            >
              <div className="mr-2">
                <svg
                  width="27"
