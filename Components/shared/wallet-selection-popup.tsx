  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="mb-4 flex items-center justify-center sm:mb-6 bg-[#8F97FE]">
          <h2 className="text-xl font-bold sm:text-2xl md:text-3xl text-white font-khand mt-2 -mb-2.5" style={{ textShadow: '2px 0 4px rgba(0, 0, 0, 0.3)' }}>
            Connect Wallet
          </h2>
            ...
            <>
              {wallets.map((wallet) => (
                <button
                  ...
                  className="flex w-full items-center justify-end gap-3 rounded-lg p-2 pr-4 transition-colors hover:bg-[#f0f0ff] active:bg-[#f0f0ff] sm:gap-4 sm:p-2.5 sm:pr-6 dark:hover:bg-[#1a1f9e] dark:active:bg-[#252ba0]"
                >
