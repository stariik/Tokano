...
function CryptoWallet({ selectedToken, setSelectedToken, tokens }) {
  ...
  return (
    <div className="max-w-4xl overflow-hidden rounded-3xl bg-[#C7C1F5] font-sans shadow-2xl lg:mx-auto dark:bg-[#231570]">
      {/* Header */}
      <div className="dark:border-secondary flex items-center justify-between border-b border-[#CDCDE9] bg-[#C7C1F5] px-6 py-3 dark:bg-[#231570]">
      ...
      <div className="px-1 md:px-2 lg:px-4">
        <div className="grid grid-cols-2 gap-1 md:gap-4">
          ...
          <div className="">
            {/* Balance Display */}
            <div className="border-opacity-40 dark:border-secondary flex items-center justify-end border-x border-[#CDCDE9] p-3">
      ...
      <div className="border-opacity-40 dark:border-secondary relative z-10 border-t border-[#CDCDE9] bg-[#ddd9f9] px-6 py-2 dark:bg-[#231570]">
