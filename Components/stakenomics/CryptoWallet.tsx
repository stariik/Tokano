                ...
                displayTokens.map((token, index) => (
                  ...
                  >
                    {token.info?.icon ? (
                      <img
                        src={token.info.icon}
                        alt={token.info?.name || "Token"}
                        className="mr-1.5 h-5 w-5 rounded-full md:mr-2 md:h-6 md:w-6"
                        onError={(e) => {
          ...
          <div className="">
            ...
            <div className="dark:border-secondary h-full flex-1 border-x-2 border-t-2 border-[#F1F1F1] p-2 md:p-4">
              {selectedTokenData ? (
                <div className="space-y-2">
                  ...
                  <div>
                    ...
                    <span className="font-khand text-xs text-[#190E79] md:text-sm xl:text-base 2xl:text-lg dark:text-white">
                      {selectedTokenData.info?.name || "Unknown"}
                    </span>
                  </div>
                  <div>
                    <span className="font-khand text-sm font-semibold text-[#190E79] lg:text-base xl:text-lg 2xl:text-xl dark:text-white">
                    ...
                    <span className="font-khand text-xs text-[#190E79] md:text-sm xl:text-base 2xl:text-lg dark:text-white">
                      {selectedTokenData.info?.symbol || "N/A"}
                    </span>
                  </div>
                  <div>
                    <span className="font-khand text-sm font-semibold text-[#190E79] lg:text-base xl:text-lg 2xl:text-xl dark:text-white">
                ...
                <div className="flex h-full items-center justify-center text-sm text-[#190E79] dark:text-white">
                  No token selected
                </div>
              )}
            </div>
