    ...
    <main className="dark:bg-dark text-light relative bg-white px-2 py-8 lg:px-6 lg:py-6">
      <div className="">
        <div className="grid lg:grid-cols-3">
          <div className="col-span-2 grid gap-4 rounded-tr-4xl lg:grid-cols-2">
            <LaunchingSoon />
            <Live />
          </div>
      ...
      <button
        ...
        className={`border-secondary fixed bottom-22 left-0 z-70 flex flex-col items-center justify-center rounded-r-lg border-x-1 border-r-1 bg-white px-2 py-1 text-sm font-bold text-[#190E79] shadow-2xl transition-all duration-300 ease-in-out [writing-mode:vertical-rl] hover:shadow-xl lg:hidden ${
