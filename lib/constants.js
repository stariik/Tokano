...
export const FUND_TYPES = [
    {
        ...
        buttonColor: "bg-[#1B00B5] hover:bg-[#1B00B5]/90 text-white dark:bg-white dark:bg-opacity-20 dark:hover:bg-opacity-30 dark:text-[#0E1379]",
    ...
    },
    {
        ...
        textColor: "text-[#190E79] dark:text-white",
        buttonColor: "bg-gray-400 cursor-not-allowed text-white dark:text-[#0E1379]",
        iconBg: "bg-white bg-opacity-20",
        disabled: true,
    },
    {
