...
import idl from '../app/testpage/tokano_staking.json';
...
export const getPoolTokensAccountPDA = async (initializer, tokenMint, extraSeed) => {
...
export const getRewardsAccountPDA = async (initializer, tokenMint, extraSeed) => {
